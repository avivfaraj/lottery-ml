...
def test_print(capsys,drawing_2):
    ...
    assert captured.out.replace("\n", "") == (f"Drawing Date: 2023-06-11 Winning numbers:  {WHITEBALL_BG}1{RESET} {WHITEBALL_BG}20{RESET} {WHITEBALL_BG}50{RESET} {WHITEBALL_BG}30{RESET} {WHITEBALL_BG}40{RESET} {POWERBALL_BG}2{RESET}")
